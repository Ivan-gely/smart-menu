<div class="container"><br>
    <form method="POST" action="<?= base_url()?>manager/establishment_validation">
        <h3 class="text-success text-center">Votre établissement</h3>
        <hr><br>

        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="name">Nom de votre établissement</label>
                <input type="text" name="name" class="form-control" id="name" value=<?=$est->name?>>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="address" id="address" value="<?=$est->address?>">
                <?php echo form_error('address'); ?>
            </div>

            <div class="form-group col-md-3">
                <label for="zip">Code postal</label>
                <input type="number" class="form-control" name="zip" id="zip" value="<?=$est->zip?>">
                <?php echo form_error('zip'); ?>
            </div>

            <div class="form-group col-md-3">
                <label for="city">Ville</label>
                <input type="text" class="form-control" name="city" id="city" value="<?=$est->city?>">
                <?php echo form_error('city'); ?>
            </div>

            <div class="form-group col-md-6">
                <label for="city">Téléphone</label>
                <input type="text" class="form-control" name="tel" id="tel" value="<?=$est->tel?>">
                <?php echo form_error('tel'); ?>
            </div>

            <div class="form-group col-md-6">
                <label for="city">Site web</label>
                <input type="text" class="form-control" name="website" id="website" value="<?=$est->website?>">
